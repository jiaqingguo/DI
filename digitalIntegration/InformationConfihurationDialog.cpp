...
void InformationConfihurationDialog::init()
{
	...
	ui->tableViewTool1->horizontalHeader()->setSectionResizeMode(1, QHeaderView::ResizeToContents);
	...
	ui->tableViewTool2->horizontalHeader()->setSectionResizeMode(1, QHeaderView::ResizeToContents);
	...
	ui->tableViewTool3->horizontalHeader()->setSectionResizeMode(1, QHeaderView::ResizeToContents);
	...
	ui->tableViewTool4->horizontalHeader()->setSectionResizeMode(1, QHeaderView::ResizeToContents);
