...
public:
    ...
    void setupUi(QDialog *AddToolInfoDialog)
    {
        ...
        AddToolInfoDialog->resize(340, 333);
        ...
        formLayout->setWidget(1, QFormLayout::FieldRole, lineEditToolPath);
