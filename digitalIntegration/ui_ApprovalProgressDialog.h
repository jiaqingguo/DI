...
public:
    ...
    void setupUi(QDialog *ApprovalProgressDialog)
    {
        ...
        btnDataQuery->setMinimumSize(QSize(0, 0));
        ...
        comboBoxUserField->setMinimumSize(QSize(0, 0));
        comboBoxUserField->setMaximumSize(QSize(16777215, 16777215));
        ...
        btnUserQuery->setMinimumSize(QSize(0, 0));
